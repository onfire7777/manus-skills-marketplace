...
curl -X POST \
  ...
  "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=REDACTED_GOOGLE_API_KEY"
```
...
**Exploitation:**
```bash
curl -H "x-goog-api-key: REDACTED_GOOGLE_API_KEY" \
...
```
AIza[A-Za-z0-9_-]{35}
Example: REDACTED_GOOGLE_API_KEY
```
